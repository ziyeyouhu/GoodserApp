...
import co.sspp.goodserapp.weight.StateView;
...
public class FindShipFragment extends BaseFragment implements SwipeRefreshLayout.OnRefreshListener,
    ...
    protected View initView(LayoutInflater inflater) {
        ...
        mStateView.getView(StateView.VIEW_STATE_ERROR).findViewById(R.id.retry).setOnClickListener(v -> {
    ...
    private void loadList() {
        mStateView.setViewState(StateView.VIEW_STATE_LOADING);
        ...
        RxRetrofitCache.load(context, "cacheKey", 1, compose, false)
                .subscribe(new RxSubscribe<ArrayList<DoFindshipInfo>>(getActivity()) {
                               ...
                               protected void _onNext(ArrayList<DoFindshipInfo> doFindshipInfos) {
                                   ...
                                   mStateView.setViewState(StateView.VIEW_STATE_CONTENT);
                               ...
                               protected void _onError(String message) {
                                   ...
                                   mStateView.setViewState(StateView.VIEW_STATE_ERROR);
                               }
